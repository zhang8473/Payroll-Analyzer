...
def histo_wage(rdd):
    ...
    # print>>sys.stdout, mean
    # print>>sys.stdout, std
    # print>>sys.stdout, years_filled
...
# def Industries(rdd,coderdd):
#     Industries=coderdd.collect()
...
if __name__ == "__main__":
    ...
    # lookuptable=sc.textFile("JobCode.csv").map(parse).map( lambda x:(x[1],x[0][0:2]) )
    # Industries(payrolls,lookuptable)
